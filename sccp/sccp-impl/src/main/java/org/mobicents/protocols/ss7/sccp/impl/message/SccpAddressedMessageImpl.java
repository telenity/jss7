...
public abstract class SccpAddressedMessageImpl extends SccpMessageImpl implements SccpAddressedMessage {
	...
	protected SccpAddressedMessageImpl(int maxDataLen, int type, int outgoingSls, int localSsn, SccpAddress calledParty, SccpAddress callingParty,
	...
	protected SccpAddressedMessageImpl(int maxDataLen, int type, int incomingOpc, int incomingDpc, int incomingSls) {
