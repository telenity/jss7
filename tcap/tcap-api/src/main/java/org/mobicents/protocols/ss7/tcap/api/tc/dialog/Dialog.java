...
public interface Dialog {
     ...
     *
     * @param event
     * @throws TCAPSendException - thrown if dialog is in bad state, ie. Being has already
     ...
     *
     * @param event
     * @throws TCAPSendException - thrown if dialog is in bad state, ie. Begin has not been
