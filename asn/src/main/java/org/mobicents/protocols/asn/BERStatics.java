...
public interface BERStatics {
	...
	int REAL_BB_SIGN_POSITIVE = 0x00;
	int REAL_BB_SIGN_NEGATIVE = 0x01;
	int REAL_BB_SIGN_MASK = 0x40;
	/**
	 * Mask for base:
	 * <ul>
	 * <li><b>00</b> base 2</li>
	 ...
	 */
	String STRING_IA5_ENCODING = "US-ASCII";
	/**
	 * Name of encoding scheme for java utils in case of UTF8
	 */
	String STRING_UTF8_ENCODING = "UTF-8";
}
