 ...
 */
public class AsnInputStreamTest {
    ...
    // those two are completely made up, couldn't find trace
    @Test
    public void testRealBinary() throws Exception {
        ...
        byte[] binary1 = new byte[]{
                ...
                (Tag.CLASS_UNIVERSAL << 6) | (Tag.PC_PRIMITIVITE << 5)
                        | Tag.REAL,
                // Length - this is definite - we don't handle more? do we?
                0x0A,// 1(info bits) 2(exponent 7(mantissa)
        ...
        assertEquals("Decoded value is not proper!!", 118.625d, d, 0.0d);
        // -118.625
