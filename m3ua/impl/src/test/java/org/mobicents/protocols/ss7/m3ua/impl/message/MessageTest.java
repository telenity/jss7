...
public class MessageTest {
    ...
    @Test
    public void testDestinationStateAudit() throws IOException {
        ByteBuf byteBuf = Unpooled.buffer();

        DestinationStateAuditImpl msg = (DestinationStateAuditImpl) messageFactory.createMessage(
        ...
        DestinationStateAuditImpl msg1 = (DestinationStateAuditImpl) messageFactory.createMessage(byteBuf);
    ...
    public void testSignallingCongestion() throws IOException {
        ...
        CongestedIndication congInd = parmFactory.createCongestedIndication(CongestedIndication.CongestionLevel.LEVEL1);
        ...
        assertEquals(msg.getCongestedIndication().getCongestionLevel(),
                msg1.getCongestedIndication().getCongestionLevel());
    }
    ...
    public void testASPUp() throws IOException {
        ...
        ASPUpImpl msg = (ASPUpImpl) messageFactory.createMessage(MessageClass.ASP_STATE_MAINTENANCE,
                MessageType.ASP_UP);
    ...
    public void testRegistrationRequest() throws IOException {
        ...
        assertEquals(msg.getRoutingKey().getLocalRKIdentifier().getId(),
                msg1.getRoutingKey().getLocalRKIdentifier().getId());
    }
    ...
    public void encodeTwoMessages() throws IOException {
        ...
        PayloadDataImpl payloadMsg = (PayloadDataImpl) messageFactory.createMessage(MessageClass.TRANSFER_MESSAGES,
                MessageType.PAYLOAD);
        ProtocolDataImpl p1 = (ProtocolDataImpl) parmFactory.createProtocolData(1408, 14150, 1, 1, 0, 0, new byte[]{1
                , 2, 3,
                4});
