...
public class GatewayTest {
    ...
    public void setUp() throws Exception {
        ...
        this.sctpManagement = new NettySctpManagementImpl("GatewayTest", 4, 4, 4);
    ...
    /**
     * @return true if sctp is supported by this OS and false if not
     */
    ...
    private class Mtp3UserPartListenerImpl implements Mtp3UserPartListener {
        ...
        private ConcurrentLinkedQueue<Mtp3TransferPrimitive> receivedData = new ConcurrentLinkedQueue<>();
