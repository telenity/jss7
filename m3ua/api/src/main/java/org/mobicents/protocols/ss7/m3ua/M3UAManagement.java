...
public interface M3UAManagement {
     ...
     * @param exchangeType               {@link ExchangeType} of this As. The handshake mechanism
     *                                   before As is ACTIVE
     * @param ipspType                   {@link IPSPType} of this As. This is used only if
     *                                   {@link Functionality} is IPSP
     * @param rc                         Optional {@link RoutingContext}
     * @param trafficMode                Optional {@link TrafficModeType}.
     * @param minAspActiveForLoadbalance Minimum {@link Asp} that should be ACTIVE before payload can
