...
//        this.management2.setSingleThread(true);
        this.management2.setPersistDir("target");
...
//        this.management3.setSingleThread(true);
        this.management3.setPersistDir("target");
    ...
    private void testAnonymousByProtocol(IpChannelType ipChannelType) throws Exception {
        ...
        await(() -> this.assDataClt1.assocUp && this.assDataClt1.assocDown, 3000);
        ...
        await(() -> !this.clientAssociation1.isConnected() && this.server.anonymAssociations.size() == 0
                && this.assDataSrv.size() == 0, 3000);
        Thread.sleep(CONNECT_DELAY + 100);
        ...
        await(() -> this.server.anonymAssociations.size() == 2 && this.assDataSrv.size() == 2
                && this.assDataClt2.rsvdMsg != null && this.assDataSrv.get(1).rsvdMsg != null, 5000);
        ...
        await(() -> this.assDataClt3.assocUp && this.assDataClt3.assocDown
                && this.server.anonymAssociations.size() == 2 && this.assDataSrv.size() == 2, 3000);
        ...
        await(() -> !this.clientAssociation3.isConnected() && this.server.anonymAssociations.size() == 2, 1000);

        // test6 - close conn1 from client side
        this.management.stopAssociation(CLIENT_ASSOCIATION_NAME1);
        await(() -> this.assDataClt1.assocDown && this.assDataSrv.get(0).assocDown
                && !this.clientAssociation1.isConnected() && this.server.anonymAssociations.size() == 1, 3000);
        ...
        await(() -> Arrays.equals(CLIENT_MESSAGE2, this.assDataSrv.get(1).rsvdMsg), 3000);
        ...
        await(() -> this.assDataClt2.assocDown && this.assDataSrv.get(1).assocDown
                && !this.clientAssociation2.isConnected() && this.server.anonymAssociations.size() == 0, 3000);
