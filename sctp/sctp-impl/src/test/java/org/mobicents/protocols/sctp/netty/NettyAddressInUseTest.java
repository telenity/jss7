...
//        this.management.setSingleThread(true);
    ...
    private void testAddressInUseByProtocol(IpChannelType ipChannelType) throws Exception {
        ...
        await(() -> clientAssocUp && serverAssocUp && this.clientAssociation.isConnected()
                && this.serverAssociation.isConnected(), 5000);
        ...
        await(() -> clientAssocDown && serverAssocDown && !this.clientAssociation.isConnected()
                && !this.serverAssociation.isConnected(), 3000);
        ...
        await(() -> !this.clientAssociation.isConnected() && !this.serverAssociation.isConnected(), 3000);
