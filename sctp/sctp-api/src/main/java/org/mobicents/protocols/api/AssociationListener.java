...
public interface AssociationListener {
     ...
     *
     * @param association
     * @param maxInboundStreams  Returns the maximum number of inbound streams that this
     ...
     * @param maxOutboundStreams Returns the maximum number of outbound streams that this
