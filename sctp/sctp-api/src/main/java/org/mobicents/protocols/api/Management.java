...
public interface Management {
     ...
     * @param maxConcurrentConnectionsCount A count of concurrent connections that can accept a Server. 0 means an unlimited count.
     * @param extraHostAddresses            When SCTP multi-homing configuration extra IP addresses can be put here
     *                                      If multi-homing absence this parameter can be null
     * @return new Server instance
     * @throws Exception Exception if management not started or server name already
     ...
     *
     * @param serverName
     * @throws Exception Exception if no Server with the passed name exist or Server
     ...
     * @throws Exception Exception if no Server found for given name or Server already
     *                   started
     */
     ...
     * @throws Exception Exception if no Server found for given name or any of the
     ...
     *
     * @param peerAddress the peer IP address that this association will accept
     *                    connection from
     * @param peerPort    the peer port that this association will accept connection
     *                    from
